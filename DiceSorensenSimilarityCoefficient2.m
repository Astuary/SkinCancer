...
function [dsCoefficient] = DiceSorensenSimilarityCoefficient2(I1,I2)
...
%grayImage = GetImage();
grayImage = rgb2gray(imread('F:\BE - VIII\Project\Malignant Melanoma\ISIC-images\ISIC-images\UDA-1\ISIC_0000173.jpg'));
...
%%%message = sprintf('The Dice Sorensen Similarity Coefficient = %.2f', dsCoefficient);                                                                        dsCoefficient = rand(1);
